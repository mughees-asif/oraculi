    ...
    <Fragment>
     <div style={{ backgroundColor: "black" }}>
      <div className="container" >
        <div className="container-icons" display ="flex" flexDirection="row" style={{ paddingTop: "5rem" }}>
            <img
              src={topAboutUsImage}
              className={classes.image}
              style={{ width: '50rem', maxWidth: 'fill-available', maxHeight: "fill-available", display: "flex", flexDirection: "column" }}
            ...
            <Card variant="outlined" style={{ backgroundColor: "black" }} >
              <Typography variant="h5" component="p" style={{ color: "white" }}>
                <p>Tutoring software that will seamlessly transform remote education by integrating 
                  ...
                  <p>The customisable CRM dashboard helps to manage daily operations such as contaacting tutors, 
